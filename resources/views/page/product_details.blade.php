            ...
            <div class="row">
                <div class="col-sm-7 d-product-body-img">
                    <div class="d-product-img-show-wrap">
                        <img src="https://www.nhaxinh.com/photo/3_92919_(1).jpg" alt="" class="d-product-main-img">
                    </div>
                    <div class="d-product-img-more-wrap row">
                        <div class="d-product-img-more__item col-sm-2">
                            <img class="d-product-img-more" src="https://www.nhaxinh.com/photo/1000-san-pham-nha-xinh(73)-4.jpg" alt="">
                        </div>
                        <div class="d-product-img-more__item col-sm-2">
                            <img class="d-product-img-more" src="https://www.nhaxinh.com/photo/1000-san-pham-nha-xinh(73)-1.jpg" alt="">
                        </div>
                        <div class="d-product-img-more__item col-sm-2">
                            <img class="d-product-img-more" src="https://www.nhaxinh.com/photo/3_92919_(1).jpg" alt="">
                        </div>
                        <div class="d-product-img-more__item col-sm-2">
                            <img class="d-product-img-more" src="https://www.nhaxinh.com/photo/1000-san-pham-nha-xinh(73)-3.jpg" alt="">
                        </div>
                        <div class="d-product-img-more__item col-sm-2">
                            <img class="d-product-img-more" src="https://www.nhaxinh.com/photo/3_92919_(2).jpg" alt="">
                        </div>
                        <div class="d-product-img-more__item col-sm-2">
                            <img class="d-product-img-more" src="https://www.nhaxinh.com/photo/giuong-skagen.jpg" alt="">
                        </div>
                    </div>
                </div>
